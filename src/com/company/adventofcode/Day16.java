...
public class Day16 {
    ...
    public static void main(String[] args) {
        ...
        d.solution("111011100000000011010100000011001000001000110000011110100101111111000101110100101111111000101000", binary.length(), 5);
    ...
    private void solution(String binary, int length, int j) {
        ...
        if (t != 4) {
            ...
            if (j == 0) {
                ...
                System.out.println("We did not prepare for this wth is going on over there?!!!!!!!!!!!!");
